...
/*Se debe crear un array de nombres de 10 posiciones y tendré que mostrar 
un menu con acciones que se deben realizar con el array
MENU:
1- Limpiar Array
2- Alamacenar nombre en posición
3- Imprimir/Mostrar Array
4- Borra nombre en opción
5- Llenar con "Posicion-x" Todo el array
6-Salir */

import javax.management.ConstructorParameters;

public class EjermploArraySimpleNumerico {
   ...
   static void desordenarTabla(int[] tabla)
   {
       ...
       for(int aux = 0; aux< tabla.length;aux++)
       {
           //en cada posicion genero un número aleatorio de 0 a longitud -1
           int nuevaPosicion = (int)(Math.random()*(tabla.length));

           //intercambio la posicion aux por la posicion nuevaPosicion
