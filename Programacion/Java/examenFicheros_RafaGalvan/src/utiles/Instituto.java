...
public class Instituto {
    ...
    public List<Alumno> getAlumnosPorProfesor(String nombreProfesor) {
    ...
    public static List<Alumno> getTodosLosAlumnosDeProfesores(List<Profesor> profesores) {
    ...
    public List<Alumno> getTodosLosAlumnosDeProfesores() {
        List<Alumno> todosLosAlumnos = new ArrayList<>();
        for (Profesor profesor : profesores) {
            todosLosAlumnos.addAll(profesor.getAlumnos());
        }
        return todosLosAlumnos;
    }    
